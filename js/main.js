    ...
    $(document).click(function(e) {
            ...
            for (var i = 0; i < search.data.length; i++) {
                if (id == search.data[i].name) {
                    ...
                    document.getElementById("Select").innerHTML = "<hr>智库导航 <img src='img/search-change.svg?v=2ae7ab8'>";
...
var time = d.getHours();
if (time < 24) {
    document.getElementById("title").innerHTML = "智库导航 | 晚上好！";
}
if (time < 18) {
    document.getElementById("title").innerHTML = "智库导航 | 下午好！";
}
if (time < 12) {
    document.getElementById("title").innerHTML = "智库导航 | 早上好！";
}
if (time < 5) {
    document.getElementById("title").innerHTML = "智库导航 | 需要休息了！";
}
//title问候语结束

//导航、引擎选择器
function select() {
    $('#folder').css('display') == 'block' ? ($('#folder').css('display', 'none'), $('#nav').css('display', 'block'), document.getElementById("Select").innerHTML = "<hr>搜索引擎 <img src='img/search-change.svg?v=2ae7ab8'>") : ($('#nav').css('display', 'none'), $('#folder').css('display', 'block'), document.getElementById("Select").innerHTML = "<hr>智库导航 <img src='img/search-change.svg?v=2ae7ab8'>");
}
//导航、引擎选择器结束
